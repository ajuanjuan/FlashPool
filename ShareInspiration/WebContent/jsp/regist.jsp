			...
			<div class="span24" style="background: white;">
				<div class="wrap">
					<div class="main clearfix">
						...
						<form id="registerForm" method="post" action="${pageContext.request.contextPath }/UserAction_registing.action" novalidate="novalidate" style="font-size: 11px;">
							<table>
								<tbody>
									<tr>
										<th>
									...
									<tr>
										...
										<td>
											<input type="submit" class="submit" value="同意以下协议并注册" style="background: #007BFF;"/>
										</td>
									</tr>
									<tr>
